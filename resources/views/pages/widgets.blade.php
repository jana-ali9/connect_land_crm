                        ...
                        <div class="col-6">
                            <div class="avatar-md bg-primary rounded">
                                <div class="avatar-title">
                                    <i class="bx bx-layer  fs-24 text-white"></i>
                                </div>
                            </div>
                        </div> <!-- end col -->
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-md bg-success rounded">
                                <div class="avatar-title">
                                    <i class="bx bx-award fs-24 text-white"></i>
                                </div>
                            </div>
                        </div> <!-- end col -->
                        <div class="col-6 text-end">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-md bg-danger rounded">
                                <div class="avatar-title">
                                    <i class="bx bxs-backpack fs-24 text-white"></i>
                                </div>
                            </div>
                        </div> <!-- end col -->
                        <div class="col-6 text-end">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="avatar-md text-bg-warning rounded">
                                <div class="avatar-title">
                                    <i class="bx bx-dollar-circle fs-24"></i>
                                </div>
                            </div>
                        </div> <!-- end col -->
                        <div class="col-6 text-end">
                ...
                <div class="card-body p-0 pb-3">
                    <div class="p-3" data-simplebar style="max-height: 386px;">
                        ...
                        <div class="form-check form-todo py-1 my-2 ps-4">
                            ...
                            <label class="form-check-label" for="customCheck4">Prioritize bugs based on severity and
                                impact </label>
                        </div>
                        <div class="form-check form-todo py-1 my-2 ps-4">
                            <input type="checkbox" class="form-check-input rounded-circle mt-0 fs-18" id="customCheck5">
                            <label class="form-check-label" for="customCheck5">Investigate and analyze the root cause of
                                each bug</label>
                        </div>
                        <div class="form-check form-todo py-1 my-2 ps-4">
