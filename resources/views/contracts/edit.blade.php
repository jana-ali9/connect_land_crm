    ...
    <div class="card-body">
        ...
        @if (auth()->user()->hasPermission("update $Name"))
            <div class="card">
                ...
                <form method="POST" action="{{ route("$Name.update", $contract->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div>
                            ...
                            @if ($contract->property_type === 'land')
                                <div class="mb-3">
                                    <label for="land_id" class="form-label">Select Land</label>
                                    <select class="form-select" id="land_id" name="land_id" required>
                                        <option disabled>Select land</option>
                                        @foreach ($lands as $land)
                                            <option value="{{ $land->id }}"
                                                {{ $contract->land_id == $land->id ? 'selected' : '' }}>
                                                {{ $land->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            @elseif ($contract->property_type === 'building')
                                <div class="mb-3 row">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select" id="building_id" name="building_id" required>
                                            ...
                                            @foreach ($buildings as $building)
                                                <option value="{{ $building->id }}"
                                                    {{ $contract->building_id == $building->id ? 'selected' : '' }}>
                                                    {{ $building->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <script>
                                    document.addEventListener("DOMContentLoaded", function() {
                                        ...
                                        const buildingsData = {!! $buildings->mapWithKeys(
                                                fn($b) => [
                                                    $b->id => $b->units->map(
                                                            fn($u) => [
                                                                'id' => $u->id,
                                        ...
                                        function loadUnits(buildingId, selectedUnitId = null) {
                                            ...
                                            units.forEach(unit => {
                                                if (unit.is_rented != 1 && unit.is_payed != 1 || unit.id == selectedUnitId) {
                                        ...
                                        const selectedBuildingId = "{{ $contract->building_id }}";
                                        const selectedUnitId = "{{ $contract->unit_id }}";
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="billing_frequency" name="billing_frequency"
                                        class="form-control" required value="{{ $contract->billing_frequency }}">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="amount_paid" name="amount_paid" class="form-control" required
                                        value="{{ $contract->invoice_price }}" value="0">
                                </div>
                                <div class="col-md-4">
                                    <label for="insurance" class="form-label">insurance</label>
                                    <input type="number" id="insurance" name="insurance" class="form-control"
                                        min="0" step="any" required value="{{ $contract->insurance }}"
                                        value="0">
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="base_rent" name="base_rent" class="form-control"
                                        min="0" step="any" required value="{{ $contract->base_rent }}">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="increase_rate" name="increase_rate" class="form-control"
                                        min="0" step="any" required value="{{ $contract->increase_rate }}"
                                        value="0">
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <input type="number" id="increase_frequency" name="increase_frequency"
                                        ...
                                        value="{{ $contract->increase_frequency }}">
                                </div>
