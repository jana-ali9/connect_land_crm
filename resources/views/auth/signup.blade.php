...
<div class="col-xl-5">
    <div class="card auth-card">
        <div class="card-body px-3 py-5">
            ...
            <div class="px-4">
                <form action="{{ route('any', 'index')}}" class="authentication-form">
                    <div class="mb-3">
    ...
    <p class="mb-0 text-center">I already have an account <a href="{{ route('second', ['auth', 'login'])}}" class="text-reset fw-bold ms-1">Sign In</a></p>
</div> <!-- end col -->
